...
export default function Scenario() {
  ...
  const {
    ...
    loading: scenLoading,
    error: scenError,
  } = useScenario(projectId, scenarioId, project?.is_demo);
  ...
  const { data: modules } = useApi(
    selectedManufacturer
      ? `/api/modules?manufacturer=${selectedManufacturer}`
      : null,
  );

  const selectedModule = modules?.find(
    (module) => module.model === selectedModel,
  );
  ...
  if (
    modules &&
    modules.length > 0 &&
    !modules.some((m) => m.model === selectedModel)
  ) {
        ...
        <div className="main-content">
          <div className="flex flex-col gap-12">
            <FieldGroup id="system">
              ...
              <Field
                data-invalid={touched.moduleAmount && !moduleAmountCheck.valid}
              >
              ...
              <Field>
                ...
                />
                <FieldDescription>
                  Orientation relative to the South, in degrees (between -180°
                  and 180°). South is 0°, West is positive, East is negative
                </FieldDescription>
              </Field>
            </FieldGroup>
              ...
              <Table>
                <TableBody>
                  <TableRow key="0">
                    ...
                    <TableCell>
                      {selectedModule ? selectedModule.technology : "—"}
                    </TableCell>
                  </TableRow>
                  <TableRow key="1">
                    ...
                    <TableCell>
                      {selectedModule
                        ? `${selectedModule.nominal_power} Wp`
                        : "—"}
                    </TableCell>
                  </TableRow>
                  <TableRow key="2">
                    ...
                    <TableCell>
                      {selectedModule ? `${selectedModule.area} m²` : "—"}
                    </TableCell>
                  </TableRow>
                  <TableRow key="3">
                    <TableCell className="font-semibold">
                    ...
                    <TableCell>
                      {selectedModule
                        ? `${selectedModule.temp_coeff_pmax}%/°C`
                        : "—"}
                    </TableCell>
                  </TableRow>
                </TableBody>
            ...
            <div className="flex items-center justify-between gap-4 rounded-lg border border-destructive/40 p-4">
              <div className="flex flex-col gap-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  This will permanently delete this scenario along with all of
                  its reports.
                </p>
              </div>
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will permanently delete this scenario along with all
                      of its reports. This action cannot be undone.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  {deleteError && (
