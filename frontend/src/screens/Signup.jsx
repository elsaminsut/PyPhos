...
export default function SignupPage() {
  ...
  const isFormValid =
    emailCheck.valid && passwordCheck.valid && confirmCheck.valid;
          ...
          <Card className="overflow-hidden rounded-2xl p-0 shadow-lg">
            <CardContent className="grid p-0 md:grid-cols-2">
              <form onSubmit={handleSubmit} className="p-6 md:p-8">
                ...
                />
                <FieldGroup>
                  <h1 className="font-instrument-serif text-4xl font-normal">
                    Create your account
                  </h1>
                  ...
                  <Field>
                    <Field
                      data-invalid={touched.password && !passwordCheck.valid}
                    >
                    ...
                    {touched.password && !passwordCheck.valid ? (
                      ...
                      <div className="flex items-start gap-2 rounded-lg bg-muted p-3 text-xs text-muted-foreground">
                        ...
                        <p>
                          Between 8 and 16 characters, with at least one
