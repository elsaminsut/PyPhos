...
export default function Report() {
  ...
  const {
    ...
    loading: projLoading,
    error: projError,
  } = useApi(`/api/projects/${projectId}`);
  const {
    data: scenario,
    loading: scenLoading,
    error: scenError,
  } = useApi(`/api/projects/${projectId}/scenarios/${scenarioId}`);
  const { data: report } = useApi(
    `/api/projects/${projectId}/scenarios/${scenarioId}/report`,
  );
                ...
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        {(scenario.installed_power / 1000).toLocaleString(
                          undefined,
                      ...
                      <Card>
                        ...
                        <CardContent className="flex flex-col gap-3">
                          ...
                          <Progress
                            value={Math.min(
                              100,
                              (report.specific_yield / report.radiation) * 100,
                            )}
                          />
